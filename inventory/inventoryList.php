    ...
    $(".btnShowEdit").click(function(){
      ...
      $.ajax({
        ...
        success: function(result){
          ...
          $("[name=unit]").val(result[5]);
          $("[name=price]").val(parseFloat(result[6]));
          $(".showImg").attr("src", "../Medicine_Image/" + result[7]);
        }
      });
    });
...
<div class="container">
  <div style="margin-top: 0%; width:88%;">
    ...
    <section class="panel table-responsive" style="margin-left: 19.8% ; margin-top: -30px; width: 96.5%;">
