...
if (isset($_POST['submit_btn'])) {
    ...
    // Login query here
    $sql = "SELECT * FROM user WHERE email = '$emailLogin' AND password = '$passwordLogin' AND is_verified = 1";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $_SESSION['id'] = $row['id'];
        $_SESSION['email'] = $row['email'];; // Add assignment operator

        $_SESSION['logged_in'] = true; // Add assignment operator
                    ...
                    <div class="container has-text-centered" style="max-width: 1132px;">
                        ...
                        <div class="column is-4 is-offset-4">
                            ...
                            <p class="has-text-grey" style="color: #00d1b2;">
                                ...
                                <a style="color: #00d1b2;" href="resetpassword.php">Forgot Password</a>
                            </p><br><br><br>
